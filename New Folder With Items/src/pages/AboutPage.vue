<template>
  ...
  >
    ...
    <div class="flex items-center px-6 py-3 bg-black-light text-white">
      ...
      <h3 class="mx-3">Focusing</h3>
    </div>

    <div class="py-4 px-6">
      <h2>Fabricio Zeferino</h2>

      <p class="py-2 text-gray-700">Full Stack Web Developer.</p>
      ...
      <div class="flex items-center mt-4 text-gray-700">
        ...
        <h5 class="px-2">fabriciozeferino@gmail.com</h5>
      </div>
    </div>
  </div>
</template>
